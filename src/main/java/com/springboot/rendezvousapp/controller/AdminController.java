...
public class AdminController {
   ...
   @PreAuthorize("permitAll()")
    ...
    public ResponseEntity<Patient> addPatient(@RequestBody Patient patient) {
        Patient addedPatient = services.addPatient(patient);
    ...
    public List<Patient> allpatient() {
        List<Patient> patients=services.allpatient();
        return patients;
    }
    @PreAuthorize("permitAll()")
    ...
    @PreAuthorize("permitAll()")
    @PostMapping("/allCliniques")
    public List<Clinique> allClinique() {
        List<Clinique> cliniques=services.allClinique();
        return cliniques;
    }
    @PreAuthorize("permitAll()")
    ...
    @PreAuthorize("permitAll()")
    @PutMapping("/getOneMedecin")
    public Medecin getOneMedecin(@RequestBody  Integer id) {
        Medecin m=services.getOneMedecin(id);
        return m;
    }
